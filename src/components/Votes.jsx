   ...
   return (
    <div className="d-flex flex-column align-items-center p-2">
      ...
      <div className="d-flex justify-between">
        <button disabled={isDisabled} className="btn btn-primary rounded-circle m-1" onClick={handleVoteClickPlus}>
        <FontAwesomeIcon icon={faArrowUp} />
        </button>
        <button  disabled={isDisabled} className="btn btn-primary rounded-circle m-1" onClick={handleVoteClickMinus}>
